...
public class Schild extends Equip {
    ...
    public Schild (int ap, int vp, int hp, int mp, int kraft, boolean fk, boolean fire, boolean earth, boolean ice, boolean air, int opfer, String name)
    {
    ...
    {
        ArrayList<Schild> list = new ArrayList<Schild>();
        ...
        list.add( new Schild(-30, 90, 0, 0, 60, false, false, false, true, false, 4, "Gletscherwall"));
        ...
        list.add( new Schild(-10, 160, 0, 0, 105, false, false, false, false, false, 6, "Aegis"));
        ...
        list.add( new Schild(20, 98, 98, 0, 55, false, true, false, false, false, 6, "Heiliger Schild des Drachentoeters"));
        ...
        list.add( new Schild(30, 70, 110, 0, 20, false, false, false, true, false, 10, "Panzer der Schildkroetenprinzessin"));
        list.add( new Schild(-80, 170, 180, 0, 85, false, false, false, false, false, 10, "Blutiger Beschuetze"));
