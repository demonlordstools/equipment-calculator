...
public class Einheiten implements Serializable {
    ...
    public static Einheiten[] erstelleEhs() {
        ...
        ehs.add(new Einheiten("Teufel", Tags.UNTOT, 520, false, 90, 900, 1000, 1000, 0, false, false, false, false));
        ehs.add(new Einheiten("Ifrit", Tags.UNTOT, 360, false, 210, 1930, 1720, 2550, 0, true, false, false, false));
