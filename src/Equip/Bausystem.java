...
public class Bausystem {
     ...
     */
    public static int stufenwert(final int stufe, final int art, final int basis, final int auslassen) {
        double base = basis;
     ...
     * berücksichtigt werden tränke, forschungen, gruppengebs und equips
     */
    public static Integer[][] Rechnen(int equi)    //1=equip1 , 2=equip2 , 3=kein equi
    {
        ...
        final Integer[][] tabelle = new Integer[11][5];
        ...
        if (einheit.rasse.equals(Tags.MENSCH)) {
            final float ap = (energiefokuss * 0.01f);
            final float vp = (heiligerRitus * 0.015f);
            final float hp = (goetterschild * 0.01f);
            final int mp = 6 * meditation;
            ...
            final float grpvp = (takti * 0.03f);
            final float grphp = (hospi * 0.02f);
            tabelle[0][2] = ((int) (einheit.vp * grpvp)) + tabelle[0][2];
            tabelle[0][3] = ((int) (einheit.hp * grphp)) + tabelle[0][3];

            if (gott == 1) {
                tabelle[0][1] = ((int) (einheit.ap * 0.3)) + tabelle[0][1];
            }
            if (gott == 2) {
                tabelle[0][2] = ((int) (einheit.vp * 0.35)) + tabelle[0][2];
            }
            if (gott == 3) {
                tabelle[0][3] = ((int) (einheit.hp * 0.25)) + tabelle[0][3];
            }
            if (gott == 4) {
                tabelle[0][4] = ((int) (einheit.mp * 0.4)) + tabelle[0][4];
            }
        }
        if (einheit.rasse.equals(Tags.UNTOT)) {
            final float ap = (verrotten * 0.02f);
            final float vp = (dunklesOmen * 0.015f);
            final float hp = (geisterruestung * 0.02f);
            final int mp = hoellenaura * 10;
            tabelle[0][1] = ((int) (einheit.ap * ap)) + tabelle[0][1];
            tabelle[0][2] = ((int) (einheit.vp * vp)) + tabelle[0][2];
            tabelle[0][3] = ((int) (einheit.hp * hp)) + tabelle[0][3];
            tabelle[0][4] = mp + tabelle[0][4];
            ...
            if (gott == 5) {
                tabelle[0][1] = ((int) (einheit.ap * 0.2)) + tabelle[0][1];
            }
            if (gott == 6) {
                tabelle[0][2] = ((int) (einheit.vp * 0.25)) + tabelle[0][2];
            }
            if (gott == 7) {
                tabelle[0][3] = ((int) (einheit.hp * 0.2)) + tabelle[0][3];
            }
        }
        if (einheit.rasse.equals(Tags.DAEMON)) {
            final float ap = (brennendesBlut * 0.02f);
            final float vp = (steinhaut * 0.02f);
            tabelle[0][1] = ((int) (einheit.ap * ap)) + tabelle[0][1];
            tabelle[0][2] = ((int) (einheit.vp * vp)) + tabelle[0][2];
            ...
            if (gott == 8) {
                tabelle[0][1] = ((int) (einheit.ap * 0.125)) + tabelle[0][1];
            }
        }
        if (einheit.rasse.equals(Tags.DRACHE)) {
            ...
            final float[][] drachis = Einheiten.drachenBasisWerte();
            float[] werte = drachis[0];
            if (einheit.name.equals("Felsendrache")) {
                werte = drachis[1];
            }
            if (einheit.name.equals("Donnervogel")) {
                werte = drachis[2];
            }
            if (einheit.name.equals("Eiswyrm")) {
                werte = drachis[3];
            }
            if (einheit.name.equals("Phoenix")) {
                werte = drachis[4];
            }

            final int grundap = tabelle[0][1] = Math.round(werte[0] * dhstufe * mult);
            final int grundvp = tabelle[0][2] = Math.round(werte[1] * dhstufe * mult);
            final int grundhp = tabelle[0][3] = Math.round(werte[2] * dhstufe * mult);
            ...
            final float ap = (drachenwut * 0.01f);
            final float vp = (drachenhaut * 0.025f);
            tabelle[0][1] = ((int) (grundap * ap)) + tabelle[0][1];
            tabelle[0][2] = ((int) (grundvp * vp)) + tabelle[0][2];

            if (gott == 9) {
                tabelle[0][1] = ((int) (grundap * 0.1)) + tabelle[0][1];
            }
            if (gott == 10) {
                tabelle[0][2] = ((int) (grundvp * 0.1)) + tabelle[0][2];
            }
        }
        ...
        switch (trank) {
            case '1': {
                tabelle[0][1] = tabelle[0][1] + 50;
                break;
            }
            case '2': {
                tabelle[0][1] = tabelle[0][1] + 150;
                break;
            }
            case '3': {
                tabelle[0][1] = tabelle[0][1] + 350;
                break;
            }
            case '4': {
                tabelle[0][1] = tabelle[0][1] + 700;
                break;
            }
            case '5': {
                tabelle[0][2] = tabelle[0][2] + 50;
                break;
            }
            case '6': {
                tabelle[0][2] = tabelle[0][2] + 150;
                break;
            }
            case '7': {
                tabelle[0][2] = tabelle[0][2] + 350;
                break;
            }
            case '8': {
                tabelle[0][2] = tabelle[0][2] + 700;
                break;
            }
            case '9': {
                tabelle[0][3] = tabelle[0][3] + 50;
                break;
            }
            case 'a': {
                tabelle[0][3] = tabelle[0][3] + 150;
                break;
            }
            case 'b': {
                tabelle[0][3] = tabelle[0][3] + 400;
                break;
            }
            case 'c': {
                tabelle[0][3] = tabelle[0][3] + 1000;
                break;
            }
            case 'd': {
                tabelle[0][4] = tabelle[0][4] + 50;
                break;
            }
            case 'e': {
                tabelle[0][4] = tabelle[0][4] + 100;
                break;
            }
            case 'f': {
                tabelle[0][4] = tabelle[0][4] + 200;
                break;
            }
            case 'g': {
                tabelle[0][4] = tabelle[0][4] + 750;
                break;
            }
            default: {
                break;
     ...
     */
    public static String basteln(final String[] elements, final int laenge) {
        final Integer[][] stufen = Rechnen(3);
        int ap = stufen[0][1];
        int vp = stufen[0][2];
        int hp = stufen[0][3];
        int mp = stufen[0][4];
        ...
        for (final String gla : elements) {
            if (gla.charAt(0) == 'e') {
                ...
                final String name = gla.substring(3);

                for (int i = 0; i < laenge; i++) {
                    if (Main.titels[i].equals(name)) {
                        titelIndex = i;
                    }
                }
                ...
                final int stufenlvln;
                if (gla.contains("10")) {
                    stufenlvln = 10;
                } else {
                    stufenlvln = Integer.parseInt("" + gla.charAt((gla.indexOf(" x") - 1)));
                }
                if (gla.contains("Ap")) {
                    ap = stufenwert(stufenlvln, 1, ap, aplvls);
                    aplvls = aplvls + stufenlvln;
                }
                if (gla.contains("Vp")) {
                    vp = stufenwert(stufenlvln, 2, vp, vplvls);
                    vplvls = vplvls + stufenlvln;
                }
                if (gla.contains("Hp")) {
                    hp = stufenwert(stufenlvln, 3, hp, hplvls);
                    hplvls = hplvls + stufenlvln;
                }
                if (gla.contains("Mp")) {
                    mp = stufenwert(stufenlvln, 4, mp, mplvls);
                    mplvls = mplvls + stufenlvln;
                }
        ...
        str.append("<html><body>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Einheit: ")
                .append(einheit.name)
                .append("<br><br>&nbsp;&nbsp;lvl: ")
                .append(aplvls + vplvls + hplvls + mplvls)
                .append("<br>&nbsp;&nbsp;Ap: ")
                .append(ap)
                .append("<br>&nbsp;&nbsp;Vp: ")
                .append(vp)
        ...
        final int op = (int) (((aplvls + vplvls + hplvls + mplvls) + 1) * (ap * 0.2432 + vp * 0.1728 + hp * 0.1408 + mp * 0.1728));
        str.append("&nbsp;&nbsp;Opferpunkte: ")
                .append(op)
                .append(" <br><br>");
        ...
        if (angelegt.weapon.Eis || einheit.ice) {
            ateis = true;
        }
        if (angelegt.weapon.Erde || einheit.earth) {
            aterde = true;
        }
        if (angelegt.weapon.Feuer || einheit.fire) {
            atfeuer = true;
        }
        if (angelegt.weapon.Wind || einheit.air) {
            atluft = true;
        }
        if (angelegt.weapon.FK) {
            weaponFk = true;
        }

        if (!atfeuer && !atluft && !aterde && !ateis && weaponFk) {
            str.append("&nbsp;&nbsp;AtElement: Keines - FK<br>");
        }
        if (atfeuer && !atluft && weaponFk) {
        ...
        if (einheit.air || angelegt.shield.Wind || angelegt.armor.Wind) {
            luft = true;
        }
        if (einheit.fire || angelegt.shield.Feuer || angelegt.armor.Feuer) {
            feuer = true;
        }
        if (einheit.earth || angelegt.shield.Erde || angelegt.armor.Erde) {
            erde = true;
        }
        if (einheit.ice || angelegt.shield.Eis || angelegt.armor.Eis) {
            eis = true;
        }

        if (!feuer && !luft && !erde && !eis) {
        ...
        Main.aktuelleserg = new EinheitenSave(
                einheit.name,
                einheit.rasse,
                angelegt.weapon.Kraft,
                weaponFk,
                spezielleKp,
                ap,
                vp,
