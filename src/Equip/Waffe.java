...
public class Waffe extends Equip {
    ...
    public static ArrayList<Waffe> erstelleWaffen() {
        final ArrayList<Waffe> list = new ArrayList<>();
        ...
        list.add(new Waffe(30, 30, 0, 0, 35, false, false, false, false, true, 2, "Tanzender Krummsäbel"));
        list.add(new Waffe(37, 9, 35, 0, 33, false, false, false, false, false, 2, "Krummsäbel"));
        ...
        list.add(new Waffe(128, -16, 0, 0, 67, true, true, false, false, false, 5, "Schwere Balliste des Drachentöters"));
        ...
        list.add(new Waffe(170, -170, 120, 0, 112, false, false, false, false, false, 5, "Große Spaltaxt"));
        list.add(new Waffe(175, -40, 0, 0, 78, true, true, false, false, false, 6, "Dämonenarmbrust"));
        ...
        list.add(new Waffe(100, 30, 5, 0, 40, false, false, false, true, false, 7, "Eissäbel"));
        list.add(new Waffe(200, 50, 0, 0, 50, false, true, false, false, false, 8, "Blutbeflecktes Schwert des Zorns"));
        list.add(new Waffe(400, 120, 120, 0, 155, false, false, false, false, false, 8, "Götterzucht"));
        list.add(new Waffe(400, 0, 0, 50, 65, false, false, false, true, false, 8, "Hammer des Gletscherkönigs"));
        list.add(new Waffe(410, -10, -10, 0, 235, false, true, false, false, false, 9, "Höllenschwert"));
        ...
        list.add(new Waffe(600, 200, 200, 20, 500, false, false, false, false, true, 10, "Mjölnir"));
        ...
        list.add(new Waffe(180, 60, 20, 0, 55, false, false, false, true, false, 10, "Tödlicher Splitter"));
